...
public class PseudoTags {
    public static class Blocks {
        public static final TagKey<Block> INCORRECT_FOR_MOLE_TOOL = createTag("incorrect_for_mole_tool");
        public static final TagKey<Block> INCORRECT_FOR_MESH_TOOL = createTag("incorrect_for_mesh_tool");
