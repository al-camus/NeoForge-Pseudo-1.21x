...
public class PseudoBlocks {
    ...
    public static final DeferredItem<BlockItem> RAW_GRAPHITE_BLOCK_ITEM =
            PseudoItems.ITEMS.register("raw_graphite_block", () -> new BlockItem(PseudoBlocks.RAW_GRAPHITE_BLOCK.get(), new Item.Properties()) {
                @Override
    ...
    public static final DeferredItem<BlockItem> GRAPHITE_DUST_BLOCK_ITEM =
            PseudoItems.ITEMS.register("graphite_dust_block", () -> new BlockItem(PseudoBlocks.GRAPHITE_DUST_BLOCK.get(), new Item.Properties()) {
                @Override
                public int getBurnTime(@NotNull ItemStack itemBlock, @Nullable RecipeType<?> recipeType) {
                    return 8000;
                }
    ...
    public static final DeferredItem<BlockItem> REFINED_GRAPHITE_BLOCK_ITEM =
            PseudoItems.ITEMS.register("refined_graphite_block", () -> new BlockItem(PseudoBlocks.REFINED_GRAPHITE_BLOCK.get(), new Item.Properties()) {
                @Override
                public int getBurnTime(@NotNull ItemStack itemBlock, @Nullable RecipeType<?> recipeType) {
                    return 24000;
                }
    ...
    public static final DeferredItem<BlockItem> REFINED_GRAPHITE_BRICK_ITEM =
            PseudoItems.ITEMS.register("refined_graphite_brick", () -> new BlockItem(PseudoBlocks.REFINED_GRAPHITE_BRICK.get(), new Item.Properties()) {
                @Override
                public int getBurnTime(@NotNull ItemStack itemBlock, @Nullable RecipeType<?> recipeType) {
                    return 24000;
                }
    ...
    public static final DeferredItem<BlockItem> MESH_CRATE_ITEM =
            PseudoItems.ITEMS.register("mesh_crate", () -> new BlockItem(PseudoBlocks.MESH_CRATE.get(),
                    new Item.Properties().fireResistant().stacksTo(1)));

    public static final DeferredItem<BlockItem> THISTLE_ITEM =
            PseudoItems.ITEMS.register("thistle", () -> new ThistleItem(THISTLE.get(), new Item.Properties()));
