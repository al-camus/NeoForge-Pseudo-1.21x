...
public class PseudoItems {
    ...
    // tools
    public static final DeferredItem<Item> MOLE_MITTS = ITEMS.register("mole_mitts", () -> new DiggingMittsItem(
            PseudoToolTiers.MOLE, PseudoTags.Blocks.MOLE_MITTS_MINEABLE,
            new Item.Properties().fireResistant().attributes(PickaxeItem.createAttributes(PseudoToolTiers.MOLE, -3.0f, -2.5f))
    ));
    public static final DeferredItem<Item> MESH_MITTS = ITEMS.register("mesh_mitts", () -> new DiggingMittsItem(
            PseudoToolTiers.MESH, PseudoTags.Blocks.MESH_MITTS_MINEABLE,
            new Item.Properties().fireResistant().attributes(PickaxeItem.createAttributes(PseudoToolTiers.MESH, -3.0f, -2.5f))
    ));
    public static final DeferredItem<Item> MESH_CHAINSAW = ITEMS.register("mesh_chainsaw", () -> new MeshChainsawItem(
            PseudoToolTiers.MESH, PseudoTags.Blocks.CHAINSAW_MINEABLE,
            new Item.Properties().fireResistant().attributes(AxeItem.createAttributes(PseudoToolTiers.MESH, -3.0f, -2.5f))
    ));
    public static final DeferredItem<Item> MESH_DRILL = ITEMS.register("mesh_drill", () -> new MeshDrillItem(
            PseudoToolTiers.MESH, PseudoTags.Blocks.DRILL_MINEABLE,
            new Item.Properties().fireResistant().attributes(PickaxeItem.createAttributes(PseudoToolTiers.MESH, -3.0f, -2.5f))
    ));
    ...
    public static final DeferredItem<PocketCrafterItem> POCKET_CRAFTER =
            ITEMS.register("pocket_crafter", () -> new PocketCrafterItem(new Item.Properties().stacksTo(1)));
    ...
    // advanced-findable
    public static final DeferredItem<Item> WARMING_STONE = ITEMS.register("warming_stone", () -> new WarmingStoneItem(new Item.Properties(), 20 * 30, 0)); // 60s, amp 0
    public static final DeferredItem<Item> MOTHER_SEA_MUSIC_DISC = ITEMS.registerItem("mother_sea_music_disc",
            properties -> new Item(properties.jukeboxPlayable(PseudoSounds.MOTHER_SEA_KEY).stacksTo(1)));
    ...
    public static final DeferredItem<Item> CURSED_SWORD = ITEMS.register("cursed_sword", () -> new SwordItem(
            PseudoToolTiers.MESH,
            new Item.Properties().attributes(SwordItem.createAttributes(PseudoToolTiers.MESH, 3, -2)).setNoRepair().fireResistant().rarity(Rarity.EPIC)
    ));
    public static final DeferredItem<Item> SLINGSHOT = ITEMS.register("slingshot", () -> new BowItem(
            new Item.Properties().durability(1000).fireResistant().setNoRepair().rarity(Rarity.EPIC)
    ));

    public static final DeferredItem<Item> CRIMSON_DAGGER = ITEMS.register("crimson_dagger", () -> new CrimsonDaggerItem(
            Tiers.IRON, new Item.Properties().durability(343).stacksTo(1).attributes(SwordItem.createAttributes(Tiers.IRON, 3, -1.6F)).fireResistant().setNoRepair().rarity(Rarity.EPIC), 0.43F, 20 * 8, 0));
